...
export interface CardSwapProps {
  ...
  children: ReactNode;
  onSwap?: (currentIndex: number) => void;
}
...
export const Card = forwardRef<HTMLDivElement, CardProps>(({ customClass, ...rest }, ref) => {
  ...
  const combinedStyle = { ...baseStyle, ...(rest.style as React.CSSProperties) };
  return (
    <div 
      ref={ref} 
      {...rest} 
...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  useEffect(() => {
    ...
    const swap = () => {
      ...
      // Notify parent immediately at the start of the swap
      if (onSwap) {
        onSwap(rest[0]);
      }
  ...
  return (
    <div 
      ...
      style={{ width, height, pointerEvents: 'none', isolation: 'isolate' }}
    >
      {rendered}
    </div>
  );
