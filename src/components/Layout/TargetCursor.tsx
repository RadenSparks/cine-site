  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      while (current && current !== document.body) {
        if (current.matches(targetSelector) && !current.closest('.no-cursor')) {
      ...
      // For buttons, use exact bounding box, no extra offset
      ...
      gsap.to(activeStrengthRef.current, { value: 1, duration: hoverDuration, ease: 'power2.out' });
    ...
    return () => {
      ...
      // Kill all tweens on cursor and corners
