...
interface StepperProps extends HTMLAttributes<HTMLDivElement> {
  ...
  disableStepIndicatorNavigation?: boolean;
...
export default function Stepper({
  ...
  disableStepIndicatorNavigation = false,
  renderStepIndicator,
  ...rest
}: StepperProps) {
              ...
              <React.Fragment key={stepNumber}>
                {renderStepIndicator ? (
                  renderStepIndicator({
                    ...
                    currentStep,
                    onStepClick: clicked => {
                      if (!disableStepIndicatorNavigation) {
                  ...
                  <StepIndicator
                    step={stepNumber}
                    disableStepIndicators={disableStepIndicators || disableStepIndicatorNavigation}
